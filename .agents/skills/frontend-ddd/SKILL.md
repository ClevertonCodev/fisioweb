...
Arquitetura obrigatória do `resources/js/`. Referência completa em `frontend-standards-fisio.md` e `AGENTS.md`. Esta skill é o **resumo acionável + templates** prontos pra uso.
