...
class AppointmentPolicy
{
    ...
    public function view(ClinicUser $user, Appointment $appointment): bool
    {
    ...
    public function update(ClinicUser $user, Appointment $appointment): bool
    {
        return $this->canManageRecord($user, $appointment);
    }

    public function cancel(ClinicUser $user, Appointment $appointment): bool
    {
        return $this->canManageRecord($user, $appointment);
    }
     ...
     */
    private function canManageRecord(ClinicUser $user, Appointment $appointment): bool
    {
    ...
    private function managesAll(ClinicUser $user): bool
    {
