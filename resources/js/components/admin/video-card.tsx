import { Info, Pencil, Play, Trash2, Video } from 'lucide-react';
            ...
            <div className="relative aspect-video overflow-hidden bg-muted">
                ...
                {canPlay && (
                    <button
                        ...
                        className="absolute inset-0 flex cursor-pointer items-center justify-center bg-foreground/20 opacity-0 transition-opacity duration-200 group-hover:opacity-100"
                    >
