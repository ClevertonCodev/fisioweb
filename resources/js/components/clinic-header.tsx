...
import { Calendar, Dumbbell, FileText, LayoutGrid, Menu, Users } from 'lucide-react';
...
export function ClinicHeader({ breadcrumbs = [] }: ClinicHeaderProps) {
