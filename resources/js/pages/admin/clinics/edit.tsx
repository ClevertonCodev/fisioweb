...
export default function EditClinic({ clinic, plans }: EditClinicProps) {
    ...
    const { data, setData, put, processing, errors, clearErrors, transform } = useForm({
        ...
        city: clinic.city ?? '',
        state: clinic.state ?? '',
        plan_id: clinic.plan_id != null ? String(clinic.plan_id) : '',
    });
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Editar', href: `/admin/clinics/${clinic.id}/edit` },
    ];

    const handleCancel = useCallback(() => {
        router.visit(`/admin/clinics/${clinic.id}`);
    }, [clinic.id]);
    ...
    const handleSubmit = useCallback(
        (e: React.FormEvent) => {
            ...
            transform((form) => ({
                ...
                plan_id: form.plan_id === '' ? null : form.plan_id,
            }));
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    <InputError message={errors.document || documentError} />
                                </div>
